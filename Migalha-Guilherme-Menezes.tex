...
\usepackage{graphicx}
\usepackage{xcolor}
\definecolor{rubired}{HTML}{030897}
...
\newcommand{\rbc}[2]{\leavevmode\begingroup
  \setbox0=\hbox{#2}%
  \hbox{\rlap{\hbox to \wd0{\hss
    \raisebox{14.4pt}[0pt][0pt]{\color{rubired}\rubyfont #1}%
  \hss}}\box0}%
  \endgroup}
\newcommand{\rbpc}[2]{\leavevmode\begingroup
  \setbox0=\hbox{#2}%
  \hbox{\rlap{\hbox to \wd0{\hss
    \raisebox{14.4pt}[0pt][0pt]{\color{rubired}\pictofont #1}%
  \hss}}\box0}%
  \endgroup}
\newcommand{\crossglyph}{{\pictofont\char"271D}}
\newcommand{\cruz}[1]{\rbc{\crossglyph}{#1}}
\newcommand{\deusinterno}{\leavevmode\begingroup
  \setbox2=\hbox{Deus}%
  \hbox{\rlap{\hbox to \wd2{\hss
    \raisebox{8.1pt}[0pt][0pt]{\fontsize{6.2}{6.2}\selectfont\pictofont\char"271D}%
  \hss}}\box2}%
  \endgroup}
\newcommand{\rbdivino}[2]{\leavevmode\begingroup
  \setbox0=\hbox{#2}%
  \raisebox{0pt}[26pt][0pt]{\hbox{%
    \rlap{\hbox to \wd0{\hss
      \raisebox{10.5pt}[0pt][0pt]{\color{rubired}\rubyfont #1}%
    \hss}}\box0}}%
  \endgroup}
\newcommand{\rbduplo}[3]{\leavevmode\begingroup
  \setbox0=\hbox{#2}%
  \raisebox{0pt}[25pt][18pt]{\hbox{%
    \rlap{\hbox to \wd0{\hss
      \raisebox{14.4pt}[0pt][0pt]{\color{rubired}\rubyfont #1}%
    \hss}}%
    \rlap{\hbox to \wd0{\hss
      \raisebox{-13.5pt}[0pt][0pt]{\color{rubired}\rubyfont #3}%
    \hss}}%
    \box0}}%
  \endgroup}
\newcommand{\lirio}{\rbpc{\char"269C}}
...
Fomos pegar enxada na casa de tia Santinha. Chamamos na porta, ela veio, olhou a gente, olhou o cachorro arrumado no braço de Júnior, feito uma \rbdivino{— \deusinterno\ o tenha.}{trouxinha, e disse}.
...
Júnior \rbp{└}{fincou a enxada} e se apoiou.

— Tu ouvisse o padre, na casa? Depois do \lirio{rosário}.

— Mais ou menos. O que tem?

— Pois eu também não esqueço. Firmino nem pisa mais em missa, tu sabe. Bina também não. Iam antigamente, no tempo do pai. E o padre foi lá assim mesmo, rezou o \lirio{rosário} com o povo, e no fim chegou perto da família e contou a história da mulher estrangeira. A que pediu pela filha doente, e o \cruz{Cristo} respondeu: $\equiv$ Não era certo tirar o pão dos filhos pra dar aos cachorros. E ela: sim, Senhor, mas até os cachorrinhos comem das migalhas que \rb{— Eita bicha ousada da p-}{caem da mesa}. E o \cruz{Cristo} \rbc{\textbf{$\equiv$ Ó mulher, grande é a tua fé!}}{se venceu, e curou ela}, e a filha. — Nessa ele apontou o queixo pro bicho, deitado na beira da cova, só esperando a vez. — Padre não conta história à toa. Aí eu venho do enterro, e esse aí!? Ah, não\ldots: e o nome, ainda mais. Me diga se é coincidência.
